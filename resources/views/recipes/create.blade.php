...
.signupSection {
  ...
  display: flex;
  color: rgb(0, 0, 0);
  box-shadow: 3px 10px 20px 5px rgb(100, 255, 69);
}

.info {
  width: 45%;
  background: rgba(110, 255, 118, 0.8);
  padding: 30px 0;
...
.splash-overlay {
   ...
   width: 100%;
   height: 100%;
   background: rgba(110, 255, 118, 0.8); /* Adjust the color and opacity as desired */
...
<body>
    ...
    <br><br>
      ...
      <div class="signupSection" data-aos="fade-up" >
        ...
        <form action="{{ route('client.recipes.store') }}" method="POST" enctype="multipart/form-data" class="signupForm" name="signupform">
            @csrf
          <h2>Recipe</h2>
          <ul class="noBullet">
            <li>
              <label for="username">Recipe Name</label>
              <input type="text" class="inputFields" id="username" name="name" placeholder="Recipe Name" required/>
            </li>
            <li>
                <div class="form-group">
                    <label for="description">Recipe's steps</label>
                    <textarea class="inputFields" name="description" placeholder="write here" required></textarea>
                  </div>
            </li>
            <li>
              <label for="">Image</label>
              <input type="file" class="inputFields" id="email" name="picture" placeholder="Image" value="" required/>
            </li>
            <li id="center-btn">
