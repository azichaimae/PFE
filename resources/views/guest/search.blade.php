                    ...
                    <div class="my-5 flex items-center justify-between">
                        ...
                        <div>
                            <a href="{{ route('guest.product.cart', $d->id) }}"
                                class="mr-4 text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">
                                Add to cart
                            </a>
                        </div>
