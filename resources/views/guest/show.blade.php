...
@section('content')
    ...
    <div class="container mt-5 font-family-montserrat" style="font-family: 'Montserrat', sans-serif;">
        <div class="flex flex-wrap">
            ...
            <div class="flex flex-col justify-center col-span-6" style="padding-left: 60px; font-family: 'Montserrat', sans-serif;">
                ...
                <a class="inline-block bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-4 rounded"
...
@section('categories')
    @foreach ($cat as $c)
        <a href="{{ route('guest.product.category', $c->id) }}" aria-current="true" style="font-family: 'Montserrat', sans-serif;"
