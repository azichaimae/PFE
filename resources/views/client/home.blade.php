...
<body class="index-page">
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="index.html#portfolio">Recepies</a></li>
  ...
  <main id="main">
    ...
    <section id="hero" class="hero">
      ...
      <img src="{{asset('assets/img/cosmetics-product-advertising-stand-exhibition-wooden-podium-green-background-with-leaves-sha.jpg')}}" alt="" data-aos="fade-in">
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
    ...
    <section id="portfolio" class="portfolio">
      ...
      <div class="container">
        ...
        <div class="button-container">
            <a href="{{route('client.recipes.index')}}" class="btn" >See more of recipies!</a>
        </div>
    </div>
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              <h3>Do you wanna see more of our work?</h3>
              <p>Go a head and click on the button to discover more products!</p>
              <a class="cta-btn" href="{{route('client.product.index')}}">Discover more</a>
            </div>
          </div>
        </div>
      </div>
